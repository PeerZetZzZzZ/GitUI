...
QT_MOC_LITERAL(4, 25, 6)
    ...
    "File\0zczytajZwrot\0\0dodaj\0commit\0"
};
...
const QMetaObject File::staticMetaObject = {
    { &Repository::staticMetaObject, qt_meta_stringdata_File.data,
...
void *File::qt_metacast(const char *_clname)
{
    ...
    return Repository::qt_metacast(_clname);
}

int File::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Repository::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
